          ...
          <div class="collapse navbar-collapse" id="navbar-header">
            ...
            <ul class="navbar-nav mr-auto">　
              <li class="nav-item"><a class="nav-link text-white" href="{{ route('info.index') }}"><i
                          class="fas fa-info-circle mr-1"></i>お知らせ</a></li>
              <li class="nav-item"><a class="nav-link text-white" href="{{ route('whats.index') }}"><i
                          class="fas fa-yin-yang mr-1"></i>CoderDojoとは？</a></li>
              @yield('extra-navi')
            </ul>
            <!-- nav-item 右寄せ -->
